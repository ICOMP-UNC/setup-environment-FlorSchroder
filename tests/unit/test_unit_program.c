/*
Para c se usa unity.h para c++ se usa gtest
Para ambos:
    - setUp es la funcion que se ejecuta antes de cada test
    - tearDown es la funcion que se ejecuta despues de cada test
    - main es la funcion que ejecuta los tests
*/
